...
//Botão abre opções de cadastro e consulta CIDADES
begin
...
//Botão abre opções de cadastro e consulta CLIENTES
begin
...
//Quando o form é clicado as opções somem
begin
  pnl_acoes_cidades.Visible   := False;
  pnl_acoes_clientes.Visible  := False;
end;
...
//Quando o form é criado arredonda os componentes
begin
...
//Quando a imagem é clicado as opções somem
begin
  pnl_acoes_cidades.Visible   := False;
  pnl_acoes_clientes.Visible  := False;
end;
